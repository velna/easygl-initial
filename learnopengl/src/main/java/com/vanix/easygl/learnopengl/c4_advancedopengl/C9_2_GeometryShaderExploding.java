...
public class C9_2_GeometryShaderExploding {
    public static void main(String[] args) throws IOException {
        ...
        try (var window = Window.of(800, 600, "LearnOpenGL");
             ...
             var model = Model.of("objects/nanosuit/nanosuit.obj")) {
            ...
            program.attachResource(Shader.Type.Vertex, "shaders/4_advanced_opengl/9.2.geometry_shader.vs")
                    .attachResource(Shader.Type.Fragment, "shaders/4_advanced_opengl/9.2.geometry_shader.fs")
                    .attachResource(Shader.Type.Geometry, "shaders/4_advanced_opengl/9.2.geometry_shader.gs")
                    .link();
