...
public class C2_3_BasicLightingExercise1 {
    public static void main(String[] args) throws IOException {
        ...
        try (var window = Window.of(800, 600, "LearnOpenGL");
            ...
            lightingProgram.attachResource(Shader.Type.Vertex, "shaders/2_lighting/2.2.basic_lighting.vs")
                    .attachResource(Shader.Type.Fragment, "shaders/2_lighting/2.2.basic_lighting.fs")
                    .link();

            lightCubeProgram.attachResource(Shader.Type.Vertex, "shaders/2_lighting/2.2.light_cube.vs")
            ...
            while (!window.shouldClose()) {
                ...
                lightingProgram.getUniform("viewPos").setVec3(camera.position());
