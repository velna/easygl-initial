...
public class C5_1_Transformations {
    public static void main(String[] args) throws IOException {
        ...
        try (var window = Window.of(800, 600, "LearnOpenGL");
            ...
            program.attachResource(Shader.Type.Vertex, "shaders/1_getting_started/5.1.transform.vs")
                    .attachResource(Shader.Type.Fragment, "shaders/1_getting_started/5.1.transform.fs")
                    .link();
